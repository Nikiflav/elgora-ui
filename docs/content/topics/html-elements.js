  ...
  "demos": [
    {
      ...
      "code": "with (Elgora) {\nfunction createDemo() {\n    const surfaceNames = [\"surface\", \"surface-2\", \"surface-3\"];\n    const content = e(\"div\", { ui: [\"elg\", \"d-flex\", \"flex-col\", \"gap-2\"] }, ...surfaceNames.map((surface, index) => e(\"div\", {\n        ui: [\"elg\", surface, \"box\", \"p-3\"]\n    }, surface + \" layer\", e(\"p\", { ui: [\"elg\", \"text-muted\", \"m-0\"] }, \"Content on \" + (index === 0 ? \"the page\" : \"a raised layer\") + \".\"))));\n    document.body.append(content);\n}\ncreateDemo();\n}",
      "mode": "readonly"
    },
    {
      "id": "html-buttons",
      ...
      "code": "with (Elgora) {\nfunction createDemo() {\n    const content = e(\"div\", { ui: [\"elg\", \"d-flex\", \"gap-2\", \"flex-wrap\"] }, e(\"button\", { ui: [\"elg\"], type: \"button\" }, \"Flat button\"), cbutton({ ui: [\"elg\", \"btn\", \"primary\"] }, \"Primary\"), cbutton({ ui: [\"elg\", \"btn\", \"neutral\"] }, \"Neutral\"), cbutton({ ui: [\"elg\", \"btn\", \"danger\"] }, \"Danger\"));\n    document.body.append(content);\n}\ncreateDemo();\n}",
      "mode": "readonly"
    },
    {
      ...
      "code": "with (Elgora) {\nfunction createDemo() {\n    const content = e(\"div\", { ui: [\"elg\", \"d-flex\", \"flex-col\", \"gap-2\"] }, e(\"input\", { ui: [\"elg\", \"field\"], type: \"text\", placeholder: \"Text input\" }), e(\"select\", { ui: [\"elg\", \"field\"] }, e(\"option\", { value: \"one\" }, \"Select an option\"), e(\"option\", { value: \"two\" }, \"Another option\")), e(\"textarea\", { ui: [\"elg\", \"field\"], rows: 3, placeholder: \"Textarea\" }), e(\"label\", { ui: [\"elg\", \"d-flex\", \"gap-1\", \"items-center\"] }, e(\"input\", { ui: [\"elg\"], type: \"checkbox\", checked: true }), \"Enable feature\"));\n    document.body.append(content);\n}\ncreateDemo();\n}",
      "mode": "readonly"
    },
    {
      "id": "html-tables",
