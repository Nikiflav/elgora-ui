...
app.mount(document.body);`)
            ...
            div({ ui: ["elg", "box", "p-4", "d-flex", "flex-col", "gap-3"] },
                ...
                div({
                    ...
                    topic("Core", "Components, VNodes, lifecycle, and observables.", "?!=/core", "ri-code-s-line"),
                    ...
                    topic("Data Grid", "Virtualized tabular data and selection.", "?!=/data-grid", "ri-table-line"),
                    topic("Virtual List", "Efficient rendering for large collections.", "?!=/virtual-list", "ri-list-check-3"),
                    topic("Scroll Engine", "Programmatic scrolling and viewport interaction.", "?!=/scroll", "ri-scroll-to-bottom-line"),
                    topic("Browser Router", "Client-side routing without full page reloads.", "?!=/router", "ri-route-line")
                )
            ),
            div({ ui: ["elg", "box", "p-4", "d-flex", "flex-col", "gap-3"] },
